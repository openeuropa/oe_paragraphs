...
Feature: Social media follow paragraph.
  ...
  Scenario Outline: Social media follow paragraph creation.
    ...
    And I fill in the 2nd "Link text" with "1st X"
    And I select "X" from the 2nd "Link type"
    And I press "Add another item" in the "social media links form element"
    And I fill in the 3rd "URL" field with "http://twitter.com"
    And I fill in the 3rd "Link text" with "2nd X"
    And I select "X" from the 3rd "Link type"
    ...
    And I should see the text "1st X"
    And I should see the text "2nd X"
