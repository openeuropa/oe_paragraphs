...
Feature: Document media paragraph.
  ...
  Scenario: Document creation.
    Given I am logged in as a user with the "create oe_demo_landing_page content, access content, edit any oe_demo_landing_page content, create document media" permission
    ...
    # Then I click "My example local document 1"
    And I press "Save"
    ...
    # Then I click "My example document 1"
    And I press "Save"
